...
{
    /// <inheritdoc />
    public partial class update110323 : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TContractID = table.Column<int>(type: "int", nullable: false),
                    TMinuteID = table.Column<int>(type: "int", nullable: false),
                    TemplateContactTContactID = table.Column<int>(type: "int", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_TypeOfService", x => x.Id);
                    table.ForeignKey(
                        name: "FK_TypeOfService_TemplateContract_TemplateContactTContactID",
                        column: x => x.TemplateContactTContactID,
                        principalTable: "TemplateContract",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_TypeOfService_TemplateMinute_TMinuteID",
                        column: x => x.TMinuteID,
                        principalTable: "TemplateMinute",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_TypeOfService_TemplateContactTContactID",
                table: "TypeOfService",
                column: "TemplateContactTContactID");

            migrationBuilder.CreateIndex(
                name: "IX_TypeOfService_TMinuteID",
                table: "TypeOfService",
                column: "TMinuteID");
        }
